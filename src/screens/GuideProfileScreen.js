...
export const GuideProfileScreen = ({ activeTab = 'profile', onTabChange, onSettingsPress, onHelpSupportPress, onTermsPrivacyPress, onEditProfilePress, onLogoutPress, onProfilePicturePress, onGetBadgePress, user: userProp, hideBottomNav = false }) => {
  ...
  // Mock guide data (use prop if provided)
  const guide = userProp || {
    name: 'Emma Williams',
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>{guide.phone}</Text>
          </View>
          <View style={styles.infoRow}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>Member since {guide.memberSince}</Text>
          </View>
        </View>
      ...
      {!hideBottomNav && <GuideBottomNavBar activeTab={activeTab} onTabChange={onTabChange} />}
    </View>
  );
};
